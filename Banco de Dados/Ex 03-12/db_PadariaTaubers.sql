create database db_TAUBERPANQUECAS;
...
insert into tb_paopaozin (Nome, description, Disponivel, Valor) values ("O PAO DO TAUBER", "Elaborado com água, farinha de ouro refinada, fermento de diamante em pó, sal de petroleo, sangue rejuvelhecido de um lendario cervo que vive apenas no pico do evertest; é um pão de massa mais pesada e menor umidade. Assim como o pão alentejano, também possui uma textura mais firme.", true, 3975.5);
